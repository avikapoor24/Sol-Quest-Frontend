			...
			<div className="navbar bg-base-100 xxl:w-[70vw] bg-white rounded-md ">
				...
				<div className="flex-none gap-2">
					...
					<div>
						...
						<div className="join  ">
							<button className="btn join-item bg-white text-black hover:bg-white">All Rewards</button>
							<button className="btn join-item bg-white text-black hover:bg-white">Token</button>
							<button className="btn join-item bg-white text-black hover:bg-white">NFT</button>
						</div>
